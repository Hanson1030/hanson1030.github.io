...
<div class="container">
    ...
    try {
        ...
        $query2 = "SELECT order_summary.order_id, customers.first_name, customers.last_name, customers.username, order_summary.purchase_date
            FROM order_summary
        ...
        if ($num > 0) {
            ...
            echo "<a href='order_update.php?id={$id}' class='btn btn-primary m-r-1em mx-3'>Edit</a>";
        }
    }

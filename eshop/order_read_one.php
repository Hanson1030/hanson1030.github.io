...
?>
    ...
    <div class="container">
        ...
        try {
            ...
            $query = "SELECT order_details.orderdetail_id, order_details.order_id, order_details.product_id, products.name, order_details.quantity 
            FROM order_details 
            INNER JOIN products 
            ...
            if ($num > 0) {
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<tr>";
                    echo "<td class='col-4'>{$product_id}</td>";
                    echo "<td class='col-4'>{$name}</td>";
                    echo "<td class='col-4'>{$quantity}</td>";
                    echo "</tr>";
                }
                // end table
                echo "</table>";
